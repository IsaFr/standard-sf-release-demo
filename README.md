...
Total_Tickets_Sold__c (Rollup)

Registration__c – Tracks attendee info with fields:
Attendee_Name__c
Attendee_Email__c
Ticket_Count__c
Event__c (Master-Detail)
...
🚀 Deployment Process
Develop & test new configurations in the Dev Org
Retrieve metadata using Gearset
Commit & push changes to a feature branch in GitHub
Create Pull Request → Review & merge into main
Gearset Pipeline automatically validates against UAT
Promote from main → UAT → Prod through Gearset
...
🎯 Building DevOps projects with Gearset pipelines & CI/CD automation.
🔗 Connect on LinkedIn: https://www.linkedin.com/in/isamarfrancisco/
